...
static void fmod_prodinfo_read_lastdata(uint16_t len, uint32_t times)
{
	...
	{		
		...
		st_product_preset.u8_Outcharger_V1_adjust_Value = un_prodinfo_rdata.st_data.u8_Outcharger_V1_adjust_Value;
		st_product_preset.u8_Outcharger_V2_adjust_Value = un_prodinfo_rdata.st_data.u8_Outcharger_V2_adjust_Value;
		st_product_preset.u16_batcore_Volt1_adjust_Value = un_prodinfo_rdata.st_data.u16_batcore_Volt1_adjust_Value;
		st_product_preset.u16_batcore_Volt2_adjust_Value = un_prodinfo_rdata.st_data.u16_batcore_Volt2_adjust_Value;
...
static void fmod_prodinfo_store_updata(void)
{
	...
	//校准值设定
	un_prodinfo_wdata.st_data.u8_Charge_I_adjust_Value = st_product_preset.u8_Charge_I_adjust_Value ;
	un_prodinfo_wdata.st_data.u8_disCharge_I1_adjust_Value=st_product_preset.u8_disCharge_I1_adjust_Value ;
	un_prodinfo_wdata.st_data.u8_disCharge_I2_adjust_Value=st_product_preset.u8_disCharge_I2_adjust_Value ;
	un_prodinfo_wdata.st_data.u8_Outcharger_V1_adjust_Value=st_product_preset.u8_Outcharger_V1_adjust_Value ;
